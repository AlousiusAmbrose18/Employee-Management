                    ...
                    <form action="/updateEmployee" method="post">
                        <div class="field">
                            <div class="input-field">
                                ...
                                <input type="text" name="name" placeholder="" value="${employee.name}" required>
                            </div>
                            <div class="input-field">
                                <label for="email">Email Id</label>
                                <input type="email" name="email" placeholder="" value="${employee.email}" required>
                            </div>
                            <div class="input-field">
                                <label for="DOB">Date of Birth</label>
                                <input type="date" name="DOB" placeholder="" value="${employee.DOB}" required>
                            </div>
                            <div class="input-field">
                                <label for="salary">Salary</label>
                                <input type="number" name="salary" placeholder="" value="${employee.salary}" required>
                            </div>
                            <div class="input-field">
